...
class HistoryBook extends LibraryV3.Book {
...
abstract class User {
    ...
    public abstract void displayBooks(LibraryV3.Book[] bookList);

    public abstract void displayBooks(ArrayList<LibraryV3.Book> bookList);
}